...
pickle.dump(Xte_day, open(traindir + 'phone_dayactive.p',"wb"))
pickle.dump(Xte_distance, open(traindir + 'phone_distance.p',"wb"))
pickle.dump(Xte_hour, open(traindir + 'phone_houractive.p',"wb"))
pickle.dump(Xte_lat, open(traindir + 'phone_lat.p',"wb"))
pickle.dump(Xte_long, open(traindir + 'phone_long.p',"wb"))
pickle.dump(Xte_weekday, open(traindir + 'phone_weekdayactive.p',"wb"))
