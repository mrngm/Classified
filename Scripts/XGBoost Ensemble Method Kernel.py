# -*- coding: utf-8 -*-
"""
Created on Mon Jun 05 14:22:20 2017

@author: Gebruiker
"""

# Get ready for lots of annoying deprecation warnings
#https://www.kaggle.com/aharless/still-trying-to-do-better-than-magic-numbers/notebook
...
#%%
micro_mean = np.exp( np.log(y_predict).mean() )

y_predict = y_predict * macro_mean / micro_mean
...
#%%
micro_mean = np.exp( np.log(y_pred).mean() )

#%%
y_predict = y_pred * macro_mean / micro_mean
humility_factor = 1.0  # Set less than 1.0 to make predictions humble
y_predict = humility_factor * (y_predict - macro_mean) + macro_mean
